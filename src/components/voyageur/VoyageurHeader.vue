...
<template>
  <header class="w-full bg-white border-b border-gray-200 sticky top-0 z-40 shadow-2xs">
    ...
    <div class="w-full py-2.5 px-4 sm:px-6 bg-white">
      <div class="max-w-4xl mx-auto flex items-center justify-between gap-3">
        ...
        <div class="flex items-center gap-2">
          ...
          <span class="bg-[#053754] text-white text-[10px] font-extrabold px-2.5 py-1 rounded-full uppercase tracking-wider hidden sm:inline-flex items-center gap-1">
            <span>✈️</span> Voyageur
          </span>
        </div>
    ...
    <!-- Sub-Header Row: Back Arrow + Route/Title Bar -->
